...
| **Sélecteur de Devise (USD/EUR/CAD)** | `src/context/CurrencyContext.tsx` | Conversion dynamique des tarifs (Sprint 890 $, Campagne 2 100 $, Masterclass 320 $ USD / 290 €) avec règles d'arrondi psychologiques. | ✅ Fonctionnel |
...
| **Showcase Vidéo** | `src/components/VideoShowcase.tsx` | Façade vidéo optimisée avec lecteur HTML5 natif pour la performance CWV. | ✅ Fonctionnel |
...
| **Sprint Publicitaire / Asset court** | 500 $ – 1 500 $ / ad | **Sprint Pilote : 890 $ USD** (barré 1 250 $ USD) | **Excellente rentabilité** pour livraison garantie sous 48-72h avec révision incluse. |
| **Campagne Multi-Vidéos Marque** | 4 000 $ – 15 000 $ / lot | **Campagne (3 Films) : 2 100 $ USD** (barré 2 950 $ USD) | **Offre groupée attractive** avec économie directe vs sprints unitaires et DA dédiée. |
| **Formation / Masterclass IA Pro** | 300 $ – 1 200 $ | **Masterclass : 320 $ USD** (290 € / 430 $ CAD) | **Excellente valeur** pour 5 modules spécialisés avec mises à jour continues. |

**Recommandation Tarifaire :**  
Conserver intégralement la grille de prix harmonisée (**Sprint 890 $ / Campagne 2 100 $ USD** et **Masterclass 320 $ USD / 290 €**). Ce positionnement défendable assure à la fois crédibilité de studio professionnel et marge saine.
...
| `src/components/HeroActions.tsx` | Manque de visibilité sur le Sprint Pilote 48h | Ajout d'un badge interactif "Sprint Pilote 48h — dès 890 $ USD" vers `/tarifs` | ✅ Fixé |
