    ...
    <div className="min-h-screen min-h-[100dvh] relative flex flex-col justify-between overflow-x-hidden bg-bg text-fg">
      ...
      >
        ...
        <div className="max-w-xl mx-auto px-4 mb-0.5 sm:mb-1.5">
          <div className="ovizai-card border border-border bg-card/90 rounded-xl p-1.5 sm:p-2.5">
            <div className="flex items-center gap-1.5 mb-1">
              <Sparkles className="w-3.5 h-3.5 text-gold" />
              <span className="mono text-[8.5px] sm:text-[9.5px] uppercase tracking-[0.2em] text-gold font-bold">
                {isFr ? 'STANDARDS DU STUDIO' : 'STUDIO STANDARDS'}
              </span>
            </div>

            <div className="grid grid-cols-3 gap-1 pt-0.5 text-center sm:text-left">
              <div className="p-1 sm:p-2 rounded-lg bg-black/40 border border-white/[0.06]">
        ...
        {/* 3. Action CTAs */}
        <div className="max-w-xl mx-auto px-4 mb-0.5 sm:mb-1 flex flex-row items-center justify-center gap-2">
          <Link
            href="/tarifs"
            className="flex-1 inline-flex items-center justify-center gap-1.5 bg-gold hover:bg-gold-bright text-black font-bold px-3 py-1 sm:py-1.5 rounded-lg mono text-[10.5px] sm:text-xs uppercase tracking-wider transition-all min-h-[32px]"
          >
          ...
          <Link
            href="/contact"
            className="flex-1 inline-flex items-center justify-center gap-1.5 bg-black/60 border border-border-strong hover:border-gold/50 text-fg hover:text-gold-bright font-bold px-3 py-1 sm:py-1.5 rounded-lg mono text-[10.5px] sm:text-xs uppercase tracking-wider transition-all min-h-[32px]"
          >
