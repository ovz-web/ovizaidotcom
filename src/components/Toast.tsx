...
export default function Toast({ message }: ToastProps) {
  ...
  return (
    <div className="fixed bottom-6 left-0 right-0 z-50 flex justify-center px-4 pointer-events-none animate-bounce-short">
      <div className="border border-gold/40 bg-black/92 backdrop-blur-md rounded-full px-4 sm:px-6 py-2.5 mono text-xs text-gold-bright shadow-toast flex items-center gap-2.5">
