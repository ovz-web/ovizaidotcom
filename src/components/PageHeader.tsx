  ...
  return (
    <div className="max-w-xl mx-auto px-4 mb-6 text-center">
      ...
      <div className="flex justify-start mb-4 sm:mb-5">
        <Link
          href={backLinkHref}
          className="inline-flex items-center gap-2 px-3 py-2 rounded-lg bg-white/[0.03] border border-border hover:border-gold/50 text-xs font-mono text-fg hover:text-gold-bright transition-all min-h-[44px] cursor-pointer"
        >
